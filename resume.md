...
Часто просматриваю доклады и презентации (Moscow Django Meetup, Piter Py, Minsk Python Meetup, Python Community Voronezh Meetup).
...
Scheduler начинался с консольного приложения, потом обзавелся веб-версией. Когда учился у университете, постоянно путал номера учебных недель, не мог найти нужных преподавателей и т.д.
