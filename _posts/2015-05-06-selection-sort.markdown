...
Сначала мы проходимся по всему массиву и находим самый наименьший элемент. Далее мы меняем этот элемент местами с элементом, занимающем индекс 0. 
...
Если расскоментировать принт, то в выводе будет полный пример того, как сортируется наш массив:
